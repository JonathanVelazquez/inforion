...
__credentials_file = os.path.abspath(os.path.join(os.getcwd(), "credentials", "credentials.ionapi"))
__data_file = os.path.abspath(os.path.join(os.getcwd(), "data", "sample.csv"))
__schema_file = os.path.abspath(os.path.join(os.getcwd(), "data", "catalog_schema.json"))
__properties_file = os.path.abspath(os.path.join(os.getcwd(), "data", "catalog_properties.json"))
